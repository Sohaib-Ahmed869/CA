...
const RPLIntakeCPC40120 = () => {
  ...
  const [formData, setFormData] = useState({
    studentInitials: "",
    studentName: "",
    courseQualification: "CPC40120 Certificate IV in Building and Construction",
    studentDeclaration: {
      name: "",
      date: "",
      signature: "",
    ...
    <div>
      ...
      <div className="border border-gray-300 rounded-md p-6 mb-6">
        <p className="mb-4">
          ...
          />{" "}
          in CPC40120 Certificate IV in Building and Construction
        </p>
        <p className="mb-6">
          This document serves as an official testimonial certifying that the
          ...
          CPC31020 Certificate III in Solid Plastering as outlined below. These
...
export default RPLIntakeCPC40120;
