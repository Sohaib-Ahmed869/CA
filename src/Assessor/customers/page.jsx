...
const AssessorCustomers = () => {
  ...
  const uploadCertificateHandler = async (id) => {
    if (!certificateFile) {
  ...
  // Request more documents handler
  const onClickRequestMoreDocuments = async () => {
    ...
    try {
      setSubmissionLoading(true);
      await requestMoreDocuments(selectedApplication.id, message);
  ...
  const handleSendToRTO = async () => {
    try {
      ...
      const response = await fetch(
        `${URL}/api/applications/sendToRTO/${selectedApplication.id}`,
        {
          method: "PUT",
          headers: {
  ...
  const handleNoteUpdate = async () => {
    try {
      setSubmissionLoading(true);
      const response = await addAssessorNoteToApplication(
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="space-y-4">
          <div className="flex items-start">
            ...
            <div>
              ...
              <p className="font-medium">
                {initialForm.formalEducation ? "Yes" : "No"} -{" "}
                {initialForm.formalEducationAnswer || "N/A"}
              </p>
            </div>
          </div>
          ...
          <div className="flex items-start">
            ...
            <div>
              <p className="text-sm text-gray-500">Location of Experience</p>
              <p className="font-medium">
                {initialForm.locationOfExperience || "N/A"}
              </p>
            </div>
          </div>
            ...
            <div>
              ...
              <p className="font-medium">
                {selectedApplication.price
                  ? `$${selectedApplication.price}`
                  : "N/A"}
                {selectedApplication.discount > 0 &&
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-start">
            <VscDebugBreakpointData className="text-emerald-600 text-xl mt-0.5 mr-3 flex-shrink-0" />
            <div>
              <p className="text-sm text-gray-500">Credits Transfer</p>
              <p className="font-medium">
                {studentForm.creditsTransfer ? "Yes" : "No"}
              </p>
            </div>
          </div>
          ...
          <div className="flex items-start">
            ...
            <div>
              ...
              <p className="font-medium">
                {studentForm.nameOfQualification || "N/A"}
              </p>
            </div>
          </div>
        </div>
    ...
    <div className="min-h-screen bg-gray-50 pb-10">
              ...
              <div className="flex items-center mb-4 md:mb-0 gap-3">
                ...
                <div>
                  <h1 className="text-2xl font-bold text-white">
                    Assessor Application Management
                  </h1>
            ...
            <div className="bg-white overflow-hidden shadow-sm rounded-lg">
              <div className="px-4 py-5 sm:px-6 border-b border-gray-200">
                ...
                <p className="mt-1 text-sm text-gray-500">
                  Applications with completed forms, documents, and payments
                </p>
              </div>
                        ...
                        return (
                          ...
                          >
                            ...
                            <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                              <button
                                className="inline-flex items-center px-3 py-1 border border-transparent text-xs font-medium rounded-md text-white bg-emerald-600 hover:bg-emerald-700 focus:outline-none mr-2"
                                onClick={() =>
                            ...
                            <button
                              ...
                              className={`relative inline-flex items-center px-4 py-2 border ${
                                page === currentPage
                                  ...
                                  : page === "..."
                                  ? "cursor-default bg-white border-gray-300 text-gray-500"
        ...
        <dialog className="modal modal-open">
          <div className="modal-box bg-white rounded-lg shadow-xl">
            ...
            <h3 className="font-bold text-lg mb-2">
              {selectedApplication.assessorNote ? "Edit Note" : "Add Note"}
            </h3>
            <textarea
              className="textarea textarea-bordered w-full mt-4 h-32"
              value={note}
            ...
            <div className="modal-action">
              ...
              >
                {selectedApplication.assessorNote ? "Update Note" : "Add Note"}
              </button>
              <button
                onClick={() => setIsAddingNote(false)}
                className="px-4 py-2 border border-gray-300 rounded-md text-gray-700 font-medium hover:bg-gray-50"
      ...
      <dialog id="uploadCertificateModal" className="modal">
        <div className="modal-box bg-white rounded-lg shadow-xl">
          ...
          <h3 className="font-bold text-lg mb-2">Upload Certificate</h3>
          <p className="text-gray-600 mb-4">
            Please select the certificate file to upload.
          </p>

          <div className="p-4 bg-gray-50 rounded-lg mb-4">
            <div className="flex flex-col items-center justify-center gap-4">
              <BiCertification className="text-5xl text-emerald-500" />
          ...
          <div className="modal-action">
            <button
              onClick={() => uploadCertificateHandler(selectedApplication.id)}
...
export default AssessorCustomers;
