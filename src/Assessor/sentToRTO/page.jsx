          ...
          <div className="card bg-base-100 shadow-sm">
            <div className="card-body">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  <p className="font-semibold">Formal Education</p>
                  <p>{application.isf?.formalEducation ? "Yes" : "No"}</p>
                </div>
              </div>
            </div>
          </div>
...
const RTOApplications = () => {
  ...
  const getApplicationsData = async () => {
    try {
      ...
      let rtoApplications = response.filter(
        (app) => app.currentStatus === "Sent to RTO"
      );
      //also ensure that application is fully paid
      rtoApplications = rtoApplications.filter((app) =>
        app.partialScheme ? app.full_paid : app.paid
      );
      setApplications(rtoApplications);
    } catch (error) {
  ...
  return (
    <div className="p-6">
      ...
      <div className="mb-6">
        <h1 className="text-2xl font-bold mb-4">RTO Applications</h1>
          ...
          <tbody>
            {currentItems.map((app) => (
              <tr key={app.id} className="hover:bg-gray-50">
                ...
                <td>{formatDate(app.status[0]?.time)}</td>
