...
import Screen2 from "../../Customer/screeningScreens/screen2";
import StateScreen from "../../Customer/screeningScreens/screen3";
import FormalEducationScreen from "../../Customer/screeningScreens/screen4";
import FinalScreen from "../../Customer/screeningScreens/screen5";
import certifiedAustralia from "../../assets/certifiedAustralia.png";
import { registerByAgent } from "../../Customer/Services/agentApplication";
...
const ScreeningFormAgent = () => {
  ...
  const onClickSubmit = async (e) => {
    ...
    try {
      const response = await registerByAgent(
        industry,
        qualification,
        yearsOfExperience,
        locationOfExperience,
...
export default ScreeningFormAgent;
